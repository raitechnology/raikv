...
flags_string( uint16_t fl,  uint8_t type,  char *buf )
{
  ...
  if ( type != 0 ) {
    ...
    switch ( type ) {
      ...
      case 0xc2: buf = copy_fl( buf, "JSON" );           break;
      case 0xae: buf = copy_fl( buf, "MARKETFEED" );     break;
      case 0xbe: buf = copy_fl( buf, "RVMSG" );          break;
      case 0xca: buf = copy_fl( buf, "RWF_FIELD_LIST" ); break;
      case 0x5c: buf = copy_fl( buf, "RWF_MAP" );        break;
      case 0x1f: buf = copy_fl( buf, "RWF_ELEMENT_LIST" ); break;
      case 0xeb: buf = copy_fl( buf, "RWF_FILTER_LIST" ); break;
      case 0x66: buf = copy_fl( buf, "RWF_SERIES" );     break;
      case 0xf3: buf = copy_fl( buf, "RWF_VECTOR" );     break;
      case 0xb7: buf = copy_fl( buf, "RWF_MSG" );        break;
      case 0x23: buf = copy_fl( buf, "RWF_MSG_KEY" );    break;
      case 0x64: buf = copy_fl( buf, "TIBMSG" );         break;
      case 0xf5: buf = copy_fl( buf, "TIB_SASS" );       break;
      case 0x40: buf = copy_fl( buf, "TIB_SASS_FORM" );  break;
    }
  }
  *buf = '\0';
  return s;
